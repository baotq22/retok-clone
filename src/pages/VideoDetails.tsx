                    ...
                    <div className="info-container">
                        ...
                        <div className="infoContainer">
                            ...
                            <Link to={`/users/${userId}`} style={{ textDecoration: "0", color: "#fff" }}>
                                ...
                                <div>
                                    {video?.fullname}
                                    <span style={{ margin: "0px 4px" }}> · </span> <span>1h ago</span>
                                </div>
                            </Link>
                    ...
                    <div className="actionContainer">
                        <div className="videoActions">
                            ...
                            <div className="actionAmount">
                                {isReacted ? (
                                    <strong>{video?.reactAmount + 1}</strong>
                                ) : (
                                    <strong>{video?.reactAmount}</strong>
                                )}
                            </div>
                            ...
                            <div className="actionAmount">
                                <strong>{video?.commentAmount}</strong>
                            </div>
                            ...
                            <div className="actionAmount">
                                <strong>{video?.savedAmount}</strong>
                            </div>
                        </div>
